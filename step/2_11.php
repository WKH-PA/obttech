...
<div class="banner_detail" style="background-image: url('<?=full_src($thongtin_step, '') ?>');">
  <div class="link_page">
    <div class="pagewrap">
     <ul>
       <h3><?=$name_titile ?></h3>
       <li><a href="<?=$full_url ?>"><i class="fa fa-home"></i><?=$glo_lang['trang_chu'] ?></a><?=$link_p ?> </li></ul>
       <div class="clr"></div>
     </div>
   </div>
 </div>
 <div class="page_conten_page pagewrap">
  ...
  <div class="content-right content-sp align-left wow fadeInDown">
  ...
  ?>
  <div id="pro_tabs" class="dv_pro_tabs">
    <ul class="listtabs">
      <?php foreach ($danhmuc as $rows) { ?>
      <li><a <?=full_href($rows) ?> class="<?=$rows['seo_name'] == $motty ? "selected" : "" ?> ">
