...
<div class="page_conten_page wow fadeInUp">
  <div class="pagewrap">
    <div id="pro_img_main" class="wow fadeInUp">
      <div class="viewLeft">
        ...
        <ul id="pro_img_slide">
          ...
          <?php
              ...
              foreach ($list_hinhcon as $rows) {
                ...
                if($i > 4) continue;
            ?>
            <li><a href='<?=checkImage($fullpath, $rows['icon'], $rows['duongdantin']) ?>' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '<?=checkImage($fullpath, $rows['icon'], $rows['duongdantin']) ?>'"><img src="<?=checkImage($fullpath, $rows['icon'], $rows['duongdantin']) ?>"></a></li>
            <?php } ?>
        </ul>
    ...
    <div class="viewRight">
      ...
      <ul class="desc">
        <?=$arr_running['p1'] != "" ? "<li>".$glo_lang['cart_ma_sp'].': <span>'.$arr_running['p1']."</span></li>" : "" ?>
    ...
    <div class="showText wow fadeInUp">
...
<div class="box_new_load wow fadeInUp">
  ...
  <div class="pagewrap">
    ...
    <div class="product_list product_list_2 product_list_slider no_box">
      <!--  -->
