...
<div class="ungtuyen_popup">
  ...
  <div class="login_link">
    <ul>
      <h3 class="fb"><a href="<?=$full_url."/?login=fb" ?>"><i class="fa fa-facebook fa-fw"></i><?=$glo_lang['dang_ky_bang_facebook'] ?></a></h3>
      <h3 class="google"><a href="<?=$full_url."/?login=google" ?>"><i class="fa fa-google fa-fw"></i><?=$glo_lang['dang_ky_bang_google'] ?></a></h3>
    </ul>
  </div>
  <div class="clr"></div>
</div>
