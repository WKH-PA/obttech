...
<div class="box_home_th">
  <div class="pagewrap">
    ...
    <div class="more_pro">
      <h3><a <?=full_href($sp_step, "?p=1") ?>><?=$glo_lang['xem_them'] ?><i class="fa fa-angle-double-down"></i></a></h3>
    </div>
  </div>
...
<div class="box_home_th_2">
  <div class="pagewrap">
    ...
    <div class="more_pro">
      <h3><a <?=full_href($sp_step, "?p=2") ?>><?=$glo_lang['xem_them'] ?><i class="fa fa-angle-double-down"></i></a></h3>
    </div>
  </div>
  </div>
</div>
...
?>
<div class="gioithieu_home_box" style="background: url(<?=full_src($hinhanh, '') ?>) center center no-repeat fixed; background-size: cover; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; -ms-background-size: cover;">
  <div class="pagewrap">
