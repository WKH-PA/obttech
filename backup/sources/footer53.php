...
<div class="footer_top">
  <div class="pagewrap">
    ...
    <div class="dv-foot-cent">
      ...
      <div class="dt-sc-newsletter-section type2 no_box">
        ...
        <form action="" method="post" name="dk_email_nhantin" id="dk_email_nhantin" enctype="multipart/form-data">
          ...
          <a onclick="DANGKY_email('<?=$full_url ?>')" class="cur"><?=$glo_lang['gui'] ?> <img src="images/loading2.gif" class="ajax_img_loading ajax_img_loading_mail"></a>
    ...
    <div class="footer-r-a">
      ...
      <iframe src="https://www.facebook.com/plugins/page.php?href=<?=$glo_lang['fanpage'] ?>&tabs=timeline&width=250&height=220&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="250" height="220" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
    </div>
    <div class="clr"></div>
  </div>
</div>
