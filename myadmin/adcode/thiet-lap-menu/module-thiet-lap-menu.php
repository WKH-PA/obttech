                      ...
                      <table class="table table-hover table-danhsach table-menu">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="name">
                                <a href="<?=$url_page ?>&edit=<?=$ida?>" title="<?=glo_lang_admin('Lưu lại') ?>"><?=$tenbaiviet_vi?></a>
                            ...
                            <!-- <td class="text-center">
                                <a href="<?=$url_page ?>&edit=<?=$ida?>" title="<?=glo_lang_admin('Lưu lại') ?>"><i class="fa fa-pencil-square-o"></i></a>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="name name_list_cap_1">
                                <a href="<?=$url_page ?>&edit=<?=$ida_1?>" title="<?=glo_lang_admin('Lưu lại') ?>"><?=$tenbaiviet_vi_1?></a>
                            ...
                            <!-- <td class="text-center">
                                <a href="<?=$url_page ?>&edit=<?=$ida_1?>" title="<?=glo_lang_admin('Lưu lại') ?>"><i class="fa fa-pencil-square-o"></i></a>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <div class="name name_list_cap_2">
                                  <a href="<?=$url_page ?>&edit=<?=$ida_2?>" title="<?=glo_lang_admin('Lưu lại') ?>" ><?=$tenbaiviet_vi_2?></a>
                              ...
                              <!-- <td class="text-center">
                                  <a href="<?=$url_page ?>&edit=<?=$ida_2?>" title="<?=glo_lang_admin('Lưu lại') ?>" ><i class="fa fa-pencil-square-o"></i></a>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div class="name name_list_cap_3">
                                    <a href="<?=$url_page ?>&edit=<?=$ida_3?>" title="<?=glo_lang_admin('Lưu lại') ?>" ><?=$tenbaiviet_vi_3?></a>
                                ...
                                <!-- <td class="text-center">
                                    <a href="<?=$url_page ?>&edit=<?=$ida_3?>" title="<?=glo_lang_admin('Lưu lại') ?>" ><i class="fa fa-pencil-square-o"></i></a>
