    ...
    <div class="row">
      ...
      <section class="col-lg-12">
        ...
        <div class="box p10">
          ...
          <label><input type='checkbox' class='minimal minimal_click' colum="mxh_is_anh" idcol="1" table="#_seo" value='1' <?=LAY_checked($thongtin['mxh_is_anh'], 1)?>> Check ảnh</label>
          <?php } ?>
          ...
          <?php } ?>
          <?php if(isset($_SESSION['admin'])){ ?>
          <label><input type='checkbox' class='minimal minimal_click' colum="mxh_is_css" idcol="1" table="#_seo" value='1' <?=LAY_checked($thongtin['mxh_is_css'], 1)?>> Check css</label>
          <?php } ?>
          ...
          <?php } ?>
          <?php if(isset($_SESSION['admin'])){ ?>
          <label><input type='checkbox' class='minimal minimal_click' colum="mxh_is_bg" idcol="1" table="#_seo" value='1' <?=LAY_checked($thongtin['mxh_is_bg'], 1)?>> Check BG</label>
          <?php } ?>
