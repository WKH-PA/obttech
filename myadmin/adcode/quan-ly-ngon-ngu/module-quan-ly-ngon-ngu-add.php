        ...
        <div class="box">
          ...
          <div class="nav-tabs-custom">
            <div class="tab-content">
              ...
              <?php if($lang_nb5){ ?>
              <div class="form-group ">
                <label>Ngôn ngữ (<?=_lang_nb5_key ?>)</label>
                <input type="text" class="form-control" name="lang_kr" value="<?=!empty($lang_kr) ? $lang_kr : ''?>">
              </div>
              <?php } ?>
              <?php if($lang_nb6){ ?>
              <div class="form-group ">
                <label>Ngôn ngữ (<?=_lang_nb6_key ?>)</label>
                <input type="text" class="form-control" name="lang_in" value="<?=!empty($lang_in) ? $lang_in : ''?>">
              </div>
              <?php } ?>
              <?php if(!empty($_SESSION['admin'])){ ?>
              <div class="form-group">
