    ...
    <div class="row">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <input type='checkbox' class='minimal minimal_click' colum="bvct_noidung" idcol="<?=$thongtin['id'] ?>" table="#_seo" value='1' <?=$thongtin['bvct_noidung'] == 1 ? 'checked="checked"' : "" ?>>
                <?php } ?>
                <div class="form-group">
      ...
      <section class="col-lg-12">
        <div class="box p10">
          ...
          <?php if(!empty($_SESSION['admin'])){ ?>
          <input type='checkbox' class='minimal minimal_click' colum="bvct_hinhanh" idcol="<?=$thongtin['id'] ?>" table="#_seo" value='1' <?=$thongtin['bvct_hinhanh'] == 1 ? 'checked="checked"' : "" ?>>
          <?php } ?>
          <div class="form-group">
          ...
          <?php if(!empty($_SESSION['admin'])){ ?>
          <input type='checkbox' class='minimal minimal_click' colum="bvct_file" idcol="<?=$thongtin['id'] ?>" table="#_seo" value='1' <?=$thongtin['bvct_file'] == 1 ? 'checked="checked"' : "" ?>>
          <?php } ?>
          <div class="form-group">
            <label for="exampleInputFile">Link Dowload <a data-tooltip="Link dowload ngoài website, ưu tiên lấy link nếu chèn link"> </a></label>
            <input type="text" class="form-control" name="dowload_text" value="<?=!empty($dowload_text) ? Show_text($dowload_text) : "" ?>">
            
          </div>
          <div class="form-group">
            <label for="exampleInputFile">File Dowload <a data-tooltip="Chỉ upload 1 file [*.pdf] [*.docx] [*.rar] [*.zip] [*.xlsx] dung lượng file tối đa 10MB"> </a></label>
