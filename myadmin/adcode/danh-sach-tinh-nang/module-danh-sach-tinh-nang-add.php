                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane <?=$tabs == 1 ? "active" : "" ?>" id="tab_<?=$tabs ?>">
                                <div class="form-group">
                                    <label>Tên tính năng (<?=$value ?>)</label>
                                    <input type="text" class="form-control"
                                           value="<?=!empty(${"tenbaiviet_".$key}) ? SHOW_text(${"tenbaiviet_".$key}) : '' ?>"
                                           name="tenbaiviet_<?=$key ?>" id="tenbaiviet_<?=$key ?>">
                                </div>
                            </div>
                            <?php } ?>
                        </div>
            ...
            <section class="col-lg-12">
                <div class="box p10">
                    ...
                    <div class="tab-pane" id="tab_4" >
                        <div class="form-group">
                            <label>Màu nền nền <input type="color" onchange="$('#ma_mau').val($(this).val())" style="padding: 0; width: 20px; height: 20px; border-radius: 100px; border: none; display: inline-block; background: none; margin-left: 5px; cursor: pointer;" value="<?=!empty($ma_mau) ? SHOW_text($ma_mau) : '#f39c72' ?>"></label>
                            <input type="text" class="form-control"
                                   value="<?=!empty($ma_mau) ? SHOW_text($ma_mau) : '#f39c72' ?>"
