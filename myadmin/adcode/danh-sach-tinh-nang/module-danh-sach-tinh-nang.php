                    ...
                    <div class="box-header">
                      <h2 class="h2_title">
                        ...
                        <h3 class="box-title box-title-td pull-right">
                          <button type="submit" name="addgiatri" class="btn btn-primary"  onclick="return CHECK_name_emty()"><i class="fa fa-floppy-o"></i> <?=glo_lang_admin('Lưu lại') ?></button>
                      ...
                      <table class="table table-hover table-danhsach">
                        <tbody>
                          <tr>
                            ...
                            <?php if($is_mamau) { ?>
                            <th class="w100 text-center">Màu nền</th>
                            <?php } ?>
                            <?php if($is_hinhanh) { ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="name">
                                <a href="<?=$url_page ?>&step=<?=$step?>&id_step=<?=$id_step?>&edit=<?=$ida?>" title="<?=glo_lang_admin('Lưu lại') ?>"><?=$tenbaiviet_vi?></a>
                            ...
                            <td class="text-center cls_timkiem">
                              <div style="width: 40px; height: 23px; margin: 0 auto; background: <?=$rows['ma_mau'] ?>"></div>
                            </td>
                            <?php } ?>
                            <?php if($is_kieuchon) { ?>
                            <td class="text-center ">
                            ...
                            <td class="text-center">
                              <div id="cus" class="cus_menu">
                                <label><input opt type='checkbox' class='minimal minimal_click' colum="opt" idcol="<?=$id ?>" table="#_baiviet_tinhnang" value='1' <?=LAY_checked($opt, 1)?>></label>
                              </div>
                            </td>
                            <?php } ?>
                            <?php if(in_array($step, $st_nhom_opt_tn_2)){ ?>
                            <td class="text-center">
                              <div id="cus" class="cus_menu">
                                <label><input opt1 type='checkbox' class='minimal minimal_click' colum="opt1" idcol="<?=$id ?>" table="#_baiviet_tinhnang" value='1' <?=LAY_checked($opt1, 1)?>></label>
                              </div>
                            </td>
                            <?php } ?>
                            <?php if(in_array($step, $st_nhom_opt_tn_3)){ ?>
                            <td class="text-center">
                              <div id="cus" class="cus_menu">
                                <label><input opt2 type='checkbox' class='minimal minimal_click' colum="opt2" idcol="<?=$id ?>" table="#_baiviet_tinhnang" value='1' <?=LAY_checked($opt2, 1)?>></label>
                              </div>
                            </td>
                            <?php } ?>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <div id="cus" class="cus_menu">
                                <label><input opt type='checkbox' class='minimal minimal_click' colum="opt" idcol="<?=$ida_2 ?>" table="#_baiviet_tinhnang" value='1' <?=LAY_checked($opt_2, 1)?>></label>
                              </div>
                            </td>
                            <?php } ?>
                            <?php if(in_array($step, $st_nhom_opt_tn_2)){ ?>
                            <td class="text-center">
                              <div id="cus" class="cus_menu">
                                <label><input opt1 type='checkbox' class='minimal minimal_click' colum="opt1" idcol="<?=$ida_2 ?>" table="#_baiviet_tinhnang" value='1' <?=LAY_checked($opt1_2, 1)?>></label>
                              </div>
                            </td>
                            <?php } ?>
                            <?php if(in_array($step, $st_nhom_opt_tn_3)){ ?>
                            <td class="text-center">
                              <div id="cus" class="cus_menu">
                                <label><input opt2 type='checkbox' class='minimal minimal_click' colum="opt2" idcol="<?=$ida_2 ?>" table="#_baiviet_tinhnang" value='1' <?=LAY_checked($opt2_2, 1)?>></label>
                              </div>
                            </td>
                            <?php } ?>
                            <td class="text-center">
