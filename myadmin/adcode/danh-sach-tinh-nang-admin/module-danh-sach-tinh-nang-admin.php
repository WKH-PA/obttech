<?php
  if(isset($_GET['them-moi']) || (isset($_GET['edit']) && is_numeric($_GET['edit']))){
    ...
    if(isset($_POST['xoa_all_data']) && md5($_POST['name_matkhau']) == "e85f20f30b8ed1625f13acb75fa4f57b"){
      ...
      DB_que("TRUNCATE `#_du_lieu_sn`");
      DB_que("TRUNCATE `#_baiviet_select_nhomgia`");
        ...
        <div class="row">
            <section class="col-lg-12">
                <div class="box">
                    <div class="box-header">
                      <h2 class="h2_title">
                        ...
                        <h3 class="box-title box-title-td pull-right">
                          <button type="submit" name="addgiatri" class="btn btn-primary"><i class="fa fa-floppy-o"></i> <?=glo_lang_admin('Lưu lại') ?></button>
                    ...
                    <div class="box-header">
                      <h3 class="box-title box-title-td pull-right">
                          <input type="text" name="name_matkhau" value="" placeholder="Mật khẩu" style="border: 1px dotted rgb(199, 199, 199); outline: none; padding: 4px 5px; width: 200px; margin-bottom: 4px; font-size: 13px; height: 32px; border-radius: 4px;">
