    ...
    <div class="row">
      ...
      <section class="col-lg-12">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane <?=$tabs == 1 ? "active" : "" ?>" id="tab_<?=$tabs ?>">
              ...
              <!-- <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?=!empty(${"noidung_".$key}) ? SHOW_text(${"noidung_".$key}) : ''?>" name="noidung_p<?=$key ?>" >
              </div> -->
            </div>
          <?php } ?>
          </div>
        ...
        <div class="box p10">
          ...
          <div class="form-group" > 
            <label>Link<a data-tooltip="Đường dẫn chuẩn bao gồm các ký tự [a-zA-Z0-9-]."> </a></label>
          ...
          <!-- <div class="form-group" > 
            <label>Link (không) <a data-tooltip="Đường dẫn chuẩn bao gồm các ký tự [a-zA-Z0-9-]."> </a></label>
            <input type="text" class="form-control" name="seo_name_1" id="seo_name_1" value="<?=!empty($seo_name_1) ? Show_text($seo_name_1) : "" ?>">
          </div>
          <div class="form-group" >
