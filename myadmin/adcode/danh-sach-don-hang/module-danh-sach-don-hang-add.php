                        ...
                        <table class="table table-hover table-danhsach">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <?php 
                                        if($donhang['thanhtoan'] == 0 ) echo "Thanh toán qua paypal";
                                        else {
                        ...
                        <table class="table table-hover table-danhsach">
                            <tbody>
                                ...
                                <?php
                                    ...
                                    $tongitne = $tongtien + $donhang['phi_ship'] - $donhang['gia_km'];
                                    $tongitne = $tongitne > 0 ? $tongitne : 0;
                                ?> 
                                <tr>
                                    <td colspan="7" style="text-align: right;font-size: 14px;">Tổng tiền: <span style="color: #F00;font-weight: 600;"><?=NUMBER_fomat($tongitne)?></span></td>
                                </tr> 
                            </tbody>
                        </table>
                    </div>
