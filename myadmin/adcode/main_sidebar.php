            ...
            <ul class="treeview-menu" >
                <?php
                    ...
                    foreach (LEFT_mainmenu_new() as $val) {
                        if(!SHOW_menu_left($glo_quyen, "", $val['id']) && !SHOW_menu_left($glo_quyen, "", "dm_".$val['id'])) continue;
                ?>
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <?php if(!in_array($val['id'], $st_an_nhom_bv) && SHOW_menu_left($glo_quyen, "", $val['id'])){ ?>
                    ...
                    <?php } if(in_array($val['id'], $array_only_bv) && SHOW_menu_left($glo_quyen, "", "dm_".$val['id'])){ ?>
                    ...
                    <?php } if(in_array($val['id'], $array_tn_nhomgia) && $_SESSION['phanquyen'] == 1){ ?>
                    <li><a href="?module=main-module&action=danh-sach-nhom-gia&them-moi=true&step=<?=$val['step'] ?>&id_step=<?=$val['id_step'] ?>"><i class="fa fa-circle-o"></i> Thêm nhóm giá</a></li>
                    <li><a href="?module=main-module&action=danh-sach-nhom-gia&step=<?=$val['step'] ?>&id_step=<?=$val['id_step'] ?>"><i class="fa fa-circle-o"></i> Danh sách nhóm giá</a></li>
                    <?php } ?>
                  </ul>
                </li>
                <?php } ?>
