                          ...
                          <tr >
                            ...
                            <td>
                              ...
                              <?php  if(isset($_SESSION['admin'])) { ?>
                                  ...
                                  ?></p>
                              <label><input opt type='checkbox' class='minimal minimal_click' colum="opt" idcol="<?=$ida ?>" table="<?=$table ?>" value='1' <?=LAY_checked($opt, 1)?>>Bật phân trang</label>
                              <?php } ?>
                              <?php  if(isset($_SESSION['admin']) || $opt == 1) { ?>
                                <div class="dv_nhom_name">
                                  <p class="name">Số lượng bài trên 1 trang... <a data-tooltip="Số lượng bài viết trong danh sách ở trang 1 trước khi qua trang 2"> </a></p>
                                  <input type="text"  value="<?=$num_view ?>" placeholder="" onchange="UPDATE_colum(this, '<?=$id ?>', 'num_view','<?=$table ?>')">
                                  <div class="clr"></div>
                                </div>
                              <?php } ?>
                              <?php if(in_array($ida, $check_img_step)){ ?>
                              <div class="dv_nhom_name">
                                  <p class="name">Kiểu cắt ảnh <a data-tooltip="<div class='dv-top-tiphd'> <span> <a><img src='images/v_1.jpg' alt=''></a> <p>Ảnh gốc</p> </span> <span> <a><img src='images/v_2.jpg' alt=''></a> <p>Ảnh cắt đúng kích thước quy định</p> </span> <span> <a><img src='images/v_3.jpg' alt=''></a> <p>Ảnh giữ đúng ảnh được upload</p> </span><div class='clr'></div> <div>"> </a></p>
                                  <select onchange="UPDATE_colum(this, '<?=$ida ?>', 'opt1','<?=$table ?> ')">
                                    <option value="0" <?=LAY_selected(0, $opt1) ?>>Cắt đúng kích thước quy định</option>
                                    <option value="1" <?=LAY_selected(1, $opt1) ?>>Giữ đúng ảnh được upload</option>
                                  </select>
                                  <div class="clr"></div>
                                </div>
                              <?php } ?>
