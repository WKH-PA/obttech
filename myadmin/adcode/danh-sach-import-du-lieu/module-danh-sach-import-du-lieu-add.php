          ...
          <div class="nav-tabs-custom">
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <div class="form-group">
                  <label>Cột Mã file <a data-tooltip="Quan trọng! Mã sản phẩm được so sánh từ CSDL và file excel để cập nhật giá"> </a></label>
                  <input type="text" class="form-control" value="<?=!empty($ma_sp) ? SHOW_text($ma_sp) : ''?>" name="ma_sp" id="ma_sp">
                </div>
                <div class="form-group">
                  <label>Cột Tên file <a data-tooltip="Giới hạn 50 cột trong excel, tính đến cột AX"> </a></label>
