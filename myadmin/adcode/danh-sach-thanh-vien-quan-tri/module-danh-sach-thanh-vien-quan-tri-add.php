<?php
  ...
  if(!empty($_POST)) {
    ...
    if(empty($tentruycap) || $tentruycap == '') {
          ...
          <div class="box">
            <div class="box-header with-border">
                ...
                <h3 class="box-title box-title-td pull-right">
                  <button onclick="return RETURN_checkSubmit()" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o"></i> <?=glo_lang_admin('Lưu lại') ?></button>
