...
<div class="login-box" style="position: relative;">
    ...
    <div class="login-box-body" style=" border-radius: 10px; border: 5px solid #ccc">
        ...
        <form name="TheForm" method="post" action="<?=$fullpath_admin ?>?action=login" id="form_login_ad">
            <input type="hidden" name="sub_botton_ad" value="forgot_pass">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <button type="button" name="admindangnhap" class="admindangnhap btn btn-primary btn-block btn-flat"  onclick="LAYMK_admin()" disabled="disabled">LẤY MẬT KHẨU <img src="images/loading2.gif" style="height: 14px; display: none" class="img_loadding_ad"></button>
