...
<section class="content-header">
    <h1><?php if(isset($_SESSION['admin'])){ ?><a onclick="LOAD_sort()" class="cur load_okkk">[SORT]</a> <?php } ?><?=$tit_glo ?></h1>
    <ol class="breadcrumb">
            ...
            <section class="col-lg-12">
                ...
                <div class="box">
                    ...
                    <div class="dv-caidat-mtk">
                      <style type="text/css">
                        .dv-caidat-cont {display: none}
                        .dv-caidat-cont.acti {display: block}
                        .dv-caidat-mtk { padding: 0 10px; }
                        .dv-caidat-mtk i { margin-right: 5px; }
                        .dv-nhom-cd span { display: inline-block; width: 200px; }
                        .dv-nhom-cd select, .dv-nhom-cd input { width: calc(100% - 220px); border: 1px solid #dcdcdc; padding: 0 6px; height: 28px; margin-top: 5px; outline: none}
                      </style>
                      ...
                      <div class="dv-caidat-cont">
                        <div class="dv-nhom-cd">
                          ...
                          <select onchange="UPDATE_colum(this, 1, 'is_vitri','#_marketing_setting')">
                            <option value="0" <?=$db_que['is_vitri'] == 0 ? "selected='selected'" : "" ?>>Bên trái dưới</option>
                            <option value="1" <?=$db_que['is_vitri'] == 1 ? "selected='selected'" : "" ?>>Bên trái trên</option>
                            <option value="2" <?=$db_que['is_vitri'] == 2 ? "selected='selected'" : "" ?>>Bên phải trên</option>
                            <option value="3" <?=$db_que['is_vitri'] == 3 ? "selected='selected'" : "" ?>>Bên phải dưới</option>
                          </select>
                          <div class="clr"></div>
                        </div>
                        <div class="dv-nhom-cd">
                          <span>Thời gian chờ load lần đầu (s)</span>
                          <input type="text" value="<?=$db_que['time_load_lan'] ?>" onchange="UPDATE_colum(this, '1', 'time_load_lan','#_marketing_setting')">
                          <div class="clr"></div>
                        </div>
                        <div class="dv-nhom-cd">
                          <span>Thời gian hiển thị (s)</span>
                          <input type="text" value="<?=$db_que['time_hien_thi'] ?>" onchange="UPDATE_colum(this, '1', 'time_hien_thi','#_marketing_setting')">
                          <div class="clr"></div>
                        </div>
                        <div class="dv-nhom-cd">
                          <span>Thời gian chờ (s)</span>
                          <input type="text" value="<?=$db_que['time_cho'] ?>" onchange="UPDATE_colum(this, '1', 'time_cho','#_marketing_setting')">
                          <div class="clr"></div>
                        </div>
                        <div class="dv-nhom-cd">
                          <span>Màu nền</span>
                          <input type="text" value="<?=$db_que['mau_nen'] ?>" onchange="UPDATE_colum(this, '1', 'mau_nen','#_marketing_setting')">
                          <div class="clr"></div>
                        </div>
                        <div class="dv-nhom-cd">
                          <span>Màu chữ</span>
                          <input type="text" value="<?=$db_que['mau_chu'] ?>" onchange="UPDATE_colum(this, '1', 'mau_chu','#_marketing_setting')">
                          <div class="clr"></div>
                        </div>
                        <div class="dv-nhom-cd">
                          <span>Màu tên</span>
                          <input type="text" value="<?=$db_que['mau_ten'] ?>" onchange="UPDATE_colum(this, '1', 'mau_ten','#_marketing_setting')">
                          <div class="clr"></div>
                        </div>
                        <!-- <div class="dv-nhom-cd">
                          <span>Màu tim</span>
