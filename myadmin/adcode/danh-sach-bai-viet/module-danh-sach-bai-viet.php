                ...
                <div class="box">
                    ...
                    <div class="dv-nhom-sppp">
                      <label class="mr-20 checkbox-mini">
                        <input type="checkbox" name="is_giamuti" class="minimal minimal_click" <?=isset($thongtin['is_giamuti']) && $thongtin['is_giamuti'] == 1 ? 'checked="checked"' : '' ?> colum="is_giamuti" idcol="1" table="#_seo" value="1"> Giá muti sp
                      </label>
                    </div>
                    <?php } ?>
