                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="name name_list_cap_1">
                                <a href="<?=$url_page ?>&step=<?=$step?>&id_step=<?=$id_step?>&edit=<?=$ida_1 ?>" title="<?=glo_lang_admin('Lưu lại') ?>"><?=$tenbaiviet_vi_1 ?></a>
                            ...
                            <?php if(in_array($step, $check_anh_dm)){ ?>
                            <td class="text-center">
                              <img class='img_show_ds' src='<?=$fullpath."/".$rows_1['duongdantin']."/".$icon_1 ?>'>
                              <?php if(isset($_SESSION['admin'])){ ?>
                              <input type="file" name="upload_<?=$cl?>">
                              <input type="hidden" name="anh_sp_<?=$cl?>" value="<?=!empty($thongtin_step['size_img_dm']) && $thongtin_step['size_img_dm'] != '' ? $thongtin_step['size_img_dm'] : '' ?>">
                              <?php } ?>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <div class="name name_list_cap_2">
                                  <a href="<?=$url_page ?>&step=<?=$step?>&id_step=<?=$id_step?>&edit=<?=$ida_2 ?>" title="<?=glo_lang_admin('Lưu lại') ?>"><?=$tenbaiviet_vi_2 ?></a>
                              ...
                              <?php if(in_array($step, $check_anh_dm)){ ?>
                              <td class="text-center">
                                <img class='img_show_ds' src='<?=$fullpath."/".$rows_2['duongdantin']."/".$icon_2 ?>'>
                                <?php if(isset($_SESSION['admin'])){ ?>
                                <input type="file" name="upload_<?=$cl?>">
                                <input type="hidden" name="anh_sp_<?=$cl?>" value="<?=!empty($thongtin_step['size_img_dm']) && $thongtin_step['size_img_dm'] != '' ? $thongtin_step['size_img_dm'] : '' ?>">
                                <?php } ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div class="name name_list_cap_3">
                                    <a href="<?=$url_page ?>&step=<?=$step?>&id_step=<?=$id_step?>&edit=<?=$ida_3 ?>" title="<?=glo_lang_admin('Lưu lại') ?>"><?=$tenbaiviet_vi_3 ?></a>
                                ...
                                <?php if(in_array($step, $check_anh_dm)){ ?>
                                <td class="text-center">
                                  <img class='img_show_ds' src='<?=$fullpath."/".$rows_3['duongdantin']."/".$icon_3 ?>'>
                                  <?php if(isset($_SESSION['admin'])){ ?>
                                  <input type="file" name="upload_<?=$cl?>">
                                  <input type="hidden" name="anh_sp_<?=$cl?>" value="<?=!empty($thongtin_step['size_img_dm']) && $thongtin_step['size_img_dm'] != '' ? $thongtin_step['size_img_dm'] : '' ?>">
                                  <?php } ?>
