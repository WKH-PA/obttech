...
<style>
  table.table.table-hover.table-danhsach.fixed tr:nth-child(1) { position: fixed; top: 0; z-index: 9; }
</style>
<script type="text/javascript">
  $(function(){
    if($(".table-danhsach").length > 0){
      ...
      var topH = $(".table.table-hover.table-danhsach").offset().top;
