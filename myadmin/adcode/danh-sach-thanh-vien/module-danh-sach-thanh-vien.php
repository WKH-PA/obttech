                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p>
                                            ...
                                            <a style="width: 20px; height: 20px; background: #3c8dbc; text-align: center; color: #fff; border-radius: 100px; line-height: 20px; margin-top: 7px;"><i class="fa fa-facebook" aria-hidden="true" style="font-size: 12px;"></i></a>
                                            <?php } if($id_google != 0){ ?>
                                            <a target="_blank" style="width: 20px; height: 20px; background: #e81a1a; text-align: center; color: #fff; border-radius: 100px; line-height: 20px; margin-top: 7px;" ><i class="fa fa-google" aria-hidden="true" style="font-size: 12px;"></i></a>
                                            <?php } ?>
                                        </p>
                                    </td> 
