    ...
    <tbody>
      ...
      <tr class="p_hover">
        ...
        <td>
          ...
          <?php if(!empty($tinhnang_arr[$num_3]['tenbaiviet_vi'])){ ?>
          <p class="a_nguoidang" style="color: #f44336;">Nhãn: <?=$tinhnang_arr[$num_3]['tenbaiviet_vi'] ?></p>
          <?php } ?>
          ...
          <div class="dv-nhom-sppp">
             <?php if(in_array($step, $st_nhom_opt3)){ ?>
                <label><input opt3 type='checkbox' class='minimal minimal_click' colum="opt3" idcol="<?=$id ?>" table="#_baiviet" value='1' <?=LAY_checked($opt3, 1)?>> <?=@$name_list_opti[$step]["op3"] ?></label>
            <?php } ?>
            <?php if(in_array($step, $st_nhom_opt4)){ ?>
                <label><input opt4 type='checkbox' class='minimal minimal_click' colum="opt4" idcol="<?=$id ?>" table="#_baiviet" value='1' <?=LAY_checked($opt4, 1)?>> <?=@$name_list_opti[$step]["op4"] ?></label>
            <?php } ?>
            <?php if(in_array($step, $st_nhom_opt5)){ ?>
                <label><input opt5 type='checkbox' class='minimal minimal_click' colum="opt5" idcol="<?=$id ?>" table="#_baiviet" value='1' <?=LAY_checked($opt5, 1)?>> <?=@$name_list_opti[$step]["op5"] ?></label>
            <?php } ?>
          </div>  
